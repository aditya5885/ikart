...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans antialiased text-slate-800 overflow-x-hidden">
      ...
      {/* ── WhatsApp FAB ── */}
      <a
        href="https://wa.me/917306653758"
        target="_blank"
        rel="noreferrer"
        aria-label="Chat with us on WhatsApp"
        className="fixed bottom-8 right-8 z-50 group flex items-center gap-3"
      >
        <span className="bg-white px-4 py-2 rounded-full shadow-xl text-sm font-bold text-slate-800 opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0 duration-200 whitespace-nowrap">
          Chat with us
        </span>
        <div className="w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl animate-bounce hover:scale-110 active:scale-95 transition-transform cursor-pointer">
