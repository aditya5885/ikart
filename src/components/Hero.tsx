...
const Hero = () => {
  ...
  const tabs = [
    { id: "international", label: "International Delivery", shortLabel: "International", icon: Globe },
    { id: "domestic", label: "Domestic Delivery", shortLabel: "Domestic", icon: Package },
    { id: "goods", label: "Goods Transportation", shortLabel: "Goods", icon: Truck },
  ];
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-5 py-1.5 sm:py-2 rounded-xl text-[10px] sm:text-sm font-bold tracking-wide transition-all duration-300 whitespace-nowrap cursor-pointer ${
                      isActive
