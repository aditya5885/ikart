          ...
          <div className="relative bg-[#0B1528] rounded-3xl p-8 sm:p-12 md:p-16 text-center border border-slate-800 shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a href="/contact" className="bg-primary-600 hover:bg-primary-700 text-white font-extrabold py-3.5 px-8 rounded-xl transition-all duration-200 shadow-lg shadow-primary-600/15 flex items-center justify-center">
                  Request Pricing
                </a>
